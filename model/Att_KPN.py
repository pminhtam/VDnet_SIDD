...
class Att_KPN(nn.Module):
    def __init__(self, color=True, burst_length=1, blind_est=False, kernel_size=[5], sep_conv=False,
    ...
    def forward(self, data_with_est):
        ...
        """
        data = data_with_est.unsqueeze(1)
...
if __name__ == '__main__':
    ...
    # print(kpn)
    print(summary(kpn, [(3, 224, 224),(1,3, 224, 224)], batch_size=1))
